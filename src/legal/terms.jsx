  ...
  return (
    <div style={{ padding: "1rem" }}>
      ...
      <p>
        ...
        <a href="https://lyntmail.com/">https://lyntmail.com/</a> and any
        related services provided by Lyntlabs LLC.{" "}
      </p>
      <p>
        By accessing <a href="https://lyntmail.com/">https://lyntmail.com/</a>,
        ...
        using any other services provided by Lyntlabs LLC.{" "}
      </p>
      <p>
        We, Lyntlabs LLC, reserve the right to review and amend any of these
      ...
      <p>These Terms of Service were last updated on 5 May 2021. </p>
      ...
      <p>
        ...
        owned by or licensed to Lyntlabs LLC and are protected by applicable
      ...
      <p>
        ...
        restrictions or the Terms of Service, and may be terminated by Lyntlabs
        LLC at any time.{" "}
      </p>
      <h3>Liability</h3>
      <p>
        Our website and the materials on our website are provided on an 'as is'
        basis. To the extent permitted by law, Lyntlabs LLC makes no warranties,
      ...
      <p>
        In no event shall Lyntlabs LLC or its suppliers be liable for any
        ...
        on this website, even if Lyntlabs LLC or an authorized representative
      ...
      <p>
        ...
        general information purposes only. Lyntlabs LLC does not warrant or make
      ...
      <h3>Links</h3>
      <p>
        Lyntlabs LLC has not reviewed all of the sites linked to its website and
        is not responsible for the contents of any such linked site. The
        inclusion of any link does not imply endorsement, approval, or control
        by Lyntlabs LLC of the site. Use of any such linked site is at your own
