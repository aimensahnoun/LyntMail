  ...
  return (
    <div style={{ padding: "1rem" }} > 
      ...
      <p>
        ...
        provided by Lyntlabs LLC under any ongoing agreement. It’s designed to
        protect us, our customers, and the general Internet community from
        unethical, irresponsible, and illegal activity.{" "}
      </p>
      <p>
        Lyntlabs LLC customers found engaging in activities prohibited by this
      ...
      <p>This policy was last reviewed on 5 May 2021. </p>
      <h3>Fair use</h3>
      <p>
        We provide our facilities with the assumption your use will be
        &ldquo;business as usual&rdquo;, as per our offer schedule. If your use
      ...
      <p>
        ...
        their users (&ldquo;end-users&rdquo;) to likewise engage our Products
        with similar intent.{" "}
      </p>
      ...
      <p>
        ...
        mailing lists or telephone number lists (&ldquo;messaging lists&rdquo;).
        ...
        email address or telephone number owner, and storing any email addresses
        or telephone numbers subscribed in this way. All messaging lists run on
        or hosted by our Products must be &ldquo;confirmed opt-in&rdquo;.
      ...
      <p>
        ...
        &ldquo;hacking&rdquo;, &ldquo;cracking&rdquo;, &ldquo;phreaking&rdquo;,
        etc.).{" "}
      </p>
      <p>
      ...
      <ol>
        ...
        <li>
          Publishing or transmitting any content of links that incite violence,
          depict a violent act, depict child pornography, or threaten anyone’s
          health and safety;
        </li>
        <li>
      ...
      <h4>Unauthorized use of Lyntlabs LLC property</h4>
      <p>
        We prohibit the impersonation of Lyntlabs LLC, the representation of a
        significant business relationship with Lyntlabs LLC, or ownership of any
        Lyntlabs LLC property (including our Products and brand) for the purpose
